...
namespace TTB
{
	...
	public class frmAbout : System.Windows.Forms.Form
    {
		...
		public frmAbout(string tenfile,TreeNode tn,int nhom)
		{
			//
			// Required for Windows Form Designer support
			//
			InitializeComponent();
            tenbv.Text = "Ngày cập nhật :" + ttb.f_modify(ttb.file_exe(tenfile)).ToString() + " - Size :" + ttb.f_size(ttb.file_exe(tenfile));
            i_nhom = nhom;
            tree = tn;
			//
		...
		private void InitializeComponent()
		{
            ...
            this.label3.Text = "Links ® Medisoft 2009";
            ...
            this.pictureBox1.Size = new System.Drawing.Size(232, 36);
            ...
            this.linkLabel1.Location = new System.Drawing.Point(153, 17);
            ...
            this.butExit.Location = new System.Drawing.Point(726, 515);
            this.butExit.Name = "butExit";
            this.butExit.Size = new System.Drawing.Size(55, 23);
		...
		{
			label4.Text=ttb.Tenbv.Trim().ToUpper();
            string filetxt = "blog_khottb2007.txt";
        ...
        private void frmAbout_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            if (e.KeyCode == Keys.F12)
            {
                ...
                else MessageBox.Show("Mật khẩu đã mã hóa !", ttb.Msg);
            }
            else if (e.KeyCode == Keys.F11)
            {
                ...
                else MessageBox.Show("Mật khẩu chưa mã hóa !", ttb.Msg);
            }
