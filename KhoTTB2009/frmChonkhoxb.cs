...
namespace Duoc
{
	...
	public class frmChonkhoxb : System.Windows.Forms.Form
	{
		...
		public frmChonkhoxb(AccessData acc,int nhom,string kho,string mmyy,string ngay,string tit,bool captoa)
		{
			//
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(frmChonkhoxb));
			...
			this.butOk.Location = new System.Drawing.Point(57, 96);
			...
			this.quay.Font = new System.Drawing.Font("Tahoma", 8.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
		...
		private void frmChonkhoxb_Load(object sender, System.EventArgs e)
		{
			...
			string sql="select * from d_dmkho where nhom="+i_nhom;
			...
			quay.ValueMember="ID";
			quay.DataSource=d.get_data("select * from d_dmloaint where nhom="+i_nhom+" order by stt").Tables[0];
		}
		...
		private void butOk_Click(object sender, System.EventArgs e)
		{
			...
			{
				MessageBox.Show("Đề nghị chọn "+label3.Text,d.Msg);
				quay.Focus();
				SendKeys.Send("{F4}");
				return;
			}
		...
		private void ngay_Validated(object sender, System.EventArgs e)
		{
			...
			{
				MessageBox.Show("Ngày không hợp lệ so với khai báo hệ thống ("+d.Ngaylv_Ngayht.ToString()+")!",d.Msg);
				ngay.Focus();
				return;
			}
		}
