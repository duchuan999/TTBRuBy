...
namespace TTB
{
	...
	/// </summary>
	public class frmChonmabd : System.Windows.Forms.Form
	{
		...
		int checkCol=0;
        private string user,s_manhom,s_nhomin;
		...
		{
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmChonmabd));
            ...
            this.butKetthuc.Location = new System.Drawing.Point(323, 380);
            ...
            this.dataGrid1.Size = new System.Drawing.Size(624, 360);
            ...
            this.tim.Location = new System.Drawing.Point(2, 348);
            this.tim.Name = "tim";
            this.tim.Size = new System.Drawing.Size(639, 21);
            this.tim.TabIndex = 1;
            ...
            this.butLuu.Location = new System.Drawing.Point(260, 380);
            ...
            this.Name = "frmChonmabd";
            this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
            this.Text = "Chọn mặt hàng";
            this.Load += new System.EventHandler(this.frmChonmabd_Load);
		...
		private void frmChonmabd_Load(object sender, System.EventArgs e)
		{
            user = ttb.user;
			dsdm.ReadXml("..\\..\\..\\xml\\ttb_dmbd.xml");
            //dsdm = ttb.get_data("select 0 id,'' ma,'' ten,'' tenhc,'' dang,'' tennhom,'' tenloai,'' tenhang,'' tennuoc,0 soluong from dual");
		...
		private void load_grid()
		{
            ...
            {
                dsdm.Clear();
                string sql = "select to_number(a.id) id,a.ma,trim(a.ten)||' '||a.hamluong as ten,a.dang,a.tenhc,b.ten as tenhang ";
                sql += " from " + user + ".ttb_dmbd a," + user + ".ttb_dmhang b," + user + ".ttb_dmnhom c where a.mahang=b.id and a.manhom=c.id and a.hide=0 and a.nhom=" + i_nhom;
                if (s_manhom != "") sql += " and a.manhom in (" + s_manhom.Substring(0, s_manhom.Length - 1) + ")";
                if (s_nhomin != "") sql += " and c.nhomin in (" + s_nhomin + ")";
                sql += " order by a.ma";
