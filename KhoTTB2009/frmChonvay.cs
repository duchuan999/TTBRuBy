...
namespace Duoc
{
	...
	public class frmChonvay : System.Windows.Forms.Form
	{
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(frmChonvay));
			...
			this.butOk.Location = new System.Drawing.Point(28, 68);
		...
		private void frmChonvay_Load(object sender, System.EventArgs e)
		{
			...
			makp.ValueMember="ID";
			sql="select * from d_dmvay where nhom="+i_nhom;
			sql+=" order by stt";
