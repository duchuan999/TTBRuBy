...
namespace TTB
{
	...
	public class frmDenghict : System.Windows.Forms.Form
	{
		...
		private int i_nhom,i_soct,i_thanhtien_le;
		...
		private void InitializeComponent()
		{
            ...
            this.ngay.Location = new System.Drawing.Point(56, 8);
            this.ngay.Name = "ngay";
            ...
            this.kinhgui.Location = new System.Drawing.Point(184, 8);
            this.kinhgui.Name = "kinhgui";
            this.kinhgui.Size = new System.Drawing.Size(384, 21);
            ...
            this.denghi.Location = new System.Drawing.Point(168, 31);
            this.denghi.Name = "denghi";
            this.denghi.Size = new System.Drawing.Size(200, 21);
            ...
            this.label5.Text = "Họ tên người đề nghị thanh toán :";
            ...
            this.butOk.Location = new System.Drawing.Point(259, 341);
            ...
            this.butCancel.Location = new System.Drawing.Point(320, 341);
            ...
            this.butLoc.Location = new System.Drawing.Point(198, 341);
		...
		private void upd_xml()
		{
			...
			ds.WriteXml("..\\..\\..\\xml\\ttb_denghi.xml",XmlWriteMode.WriteSchema);
		}
		...
		private void tendv_Validated(object sender, System.EventArgs e)
		{
			...
			{
				DataRow r=ttb.getrowbyid(dtdmnx,"ten='"+tendv.Text+"'");
		...
		private void butLoc_Click(object sender, System.EventArgs e)
		{
			...
			for(int i=y1;i<=y2;i++)
			{
				...
				for(int j=itu;j<=iden;j++)
				{
					...
					if (ttb.bMmyy(mmyy))
					{
						sql="select distinct to_char(a.ngayhd,'dd/mm/yyyy')||'     '||a.sohd as songay,a.sohd from xxx.ttb_nhapll a,"+user+".ttb_dmnx b where a.madv=b.id";
						sql+=" and a.ngayhd between to_date('"+tu.Text+"','"+f_ngay+"') and to_date('"+den.Text+"','"+f_ngay+"')";
						if (madv.Text!="") sql+=" and trim(b.ma)='"+madv.Text+"'";
						sql+=" and a.nhom="+i_nhom;
                        sql1 = sql.Replace("xxx", user);
						if (be) dtsohd=ttb.get_data(sql1).Tables[0];
						else dtsohd=ttb.get_data(sql1).Tables[0].Copy();
						be=false;
					}
				}
			}
