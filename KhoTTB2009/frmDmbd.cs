...
namespace TTB
{
	...
	public class frmDmbd : System.Windows.Forms.Form
	{
		...
		public frmDmbd(LibTTB.AccessData acc,int nhom,string mmyy,bool admin,string _manhom,int userid)
		{
			//
		...
		private void InitializeComponent()
		{
            ...
            this.listDang = new List();
            this.listLoai = new List();
            this.listHang = new List();
            this.listNuoc = new List();
            this.listNhombo = new List();
            this.listSotk = new List();
            this.listNhom = new List();
            ...
            this.butKetthuc.Location = new System.Drawing.Point(410, 501);
            ...
            this.ten.Name = "ten";
            this.ten.Size = new System.Drawing.Size(298, 21);
            this.ten.TabIndex = 1;
            ...
            this.butMoi.Location = new System.Drawing.Point(44, 501);
            ...
            this.butSua.Location = new System.Drawing.Point(104, 501);
            ...
            this.butLuu.Location = new System.Drawing.Point(164, 501);
            ...
            this.butBoqua.Location = new System.Drawing.Point(224, 501);
            ...
            this.butHuy.Location = new System.Drawing.Point(290, 501);
            ...
            this.lSotk.Location = new System.Drawing.Point(381, 456);
            ...
            this.label9.Location = new System.Drawing.Point(401, 388);
            ...
            this.lPhanloai.Location = new System.Drawing.Point(225, 409);
            ...
            this.lHang.Location = new System.Drawing.Point(430, 409);
            ...
            this.manhom.Size = new System.Drawing.Size(184, 21);
            ...
            this.maloai.Size = new System.Drawing.Size(154, 21);
            ...
            this.listDang.MatchEntryStyle = MatchEntryStyle.FirstLetterInsensitive;
            ...
            this.listLoai.MatchEntryStyle = MatchEntryStyle.FirstLetterInsensitive;
            ...
            this.listHang.MatchEntryStyle = MatchEntryStyle.FirstLetterInsensitive;
            ...
            this.listNuoc.MatchEntryStyle = MatchEntryStyle.FirstLetterInsensitive;
            ...
            this.listNhombo.MatchEntryStyle = MatchEntryStyle.FirstLetterInsensitive;
            ...
            this.listSotk.MatchEntryStyle = MatchEntryStyle.FirstLetterInsensitive;
            ...
            this.listNhom.MatchEntryStyle = MatchEntryStyle.FirstLetterInsensitive;
            ...
            this.butIn.Location = new System.Drawing.Point(350, 501);
            ...
            this.ltyle.Location = new System.Drawing.Point(185, 453);
            ...
            this.butSTT.Location = new System.Drawing.Point(3, 528);
            ...
            this.listNhomin.MatchEntryStyle = MatchEntryStyle.FirstLetterInsensitive;
            ...
            this.butNo.Location = new System.Drawing.Point(-1, 388);
		...
		private void butLuu_Click(object sender, System.EventArgs e)
		{
            ...
            //    try
            //    {
            //        finfo = new FileInfo(pic.Tag.ToString());
            ...
            //if (pic.Tag != null && hostPicture!="")
            //{
            //    try
            //    {
            //        File.Copy(pic.Tag.ToString(), hostPicture + "\\" + l_id + filetype, true);
            //    }
            //    catch //(Exception exx)
            //    {
            //        pic.Tag = null;
            ...
            //            (tyle.Text != "") ? decimal.Parse(tyle.Text) : 0, stt.Value, "", iNhomin, 0, "",
            //            duongdung.Text, 0, dang.Text, 1, dang.Text))
            //        {
            ...
            //    if (pic.Tag != null)
            //    {
            //        if (!ttb.upd_dmbd(l_id, ma.Text, ten.Text, dang.Text, hamluong.Text, iNhom, iLoai, iHang, 
            //            iNuoc, iNhombo, (chkBHYT.Checked) ? 1 : 0, 0, iSotk, "", "", 1, i_nhom, sodk.Text,
            //            (sltoithieu.Text == "") ? 0 : decimal.Parse(sltoithieu.Text), 0, 0, 0, 
            //            (tyle.Text != "") ? decimal.Parse(tyle.Text) : 0, stt.Value, "" + l_id + filetype, 
            //            iNhomin, 0, "", duongdung.Text, 0, dang.Text, 1, dang.Text))
            //        {
            //            if (!ttb.upd_dmbd(l_id, ma.Text, ten.Text, dang.Text, hamluong.Text, iNhom, iLoai, iHang,
            //                iNuoc, iNhombo, (chkBHYT.Checked) ? 1 : 0, 0, iSotk, "", "", 1, i_nhom, sodk.Text, 
            //                (sltoithieu.Text == "") ? 0 : decimal.Parse(sltoithieu.Text), 0, 0, 0, 
            ...
            //{
                if (!ttb.upd_dmbd(l_id, ma.Text, ten.Text, dang.Text, hamluong.Text, iNhom, iLoai, iHang, iNuoc,
                    iNhombo, (chkBHYT.Checked) ? 1 : 0, 0, iSotk, "", "", 1, i_nhom, sodk.Text, 
                    (sltoithieu.Text == "") ? 0 : decimal.Parse(sltoithieu.Text), 0, 0, 0,
                    (tyle.Text != "") ? decimal.Parse(tyle.Text) : 0, stt.Value, (byte[])pic.Tag, iNhomin, 0, "",
            ...
            //}
            //ttb.execute_data("update " + user + ".ttb_dmbd set hide=" + ((hide.Checked) ? 1 : 0) + " where id=" + l_id);
            //if (sodk.Text!="") ttb.execute_data("update " + user + ".ttb_theodoi set losx='" + sodk.Text + "' where mabd=" + l_id);
            //if (pic.Visible) ttb.upd_dmbd(l_id,(byte[])(pic.Tag));
		...
		private void ref_text(decimal id)
		{
			try
			{
				...
				if (r!=null)
				{
                    ...
                    chkBHYT.Checked = (r["bhyt"].ToString() == "1" || r["bhyt"].ToString() == "1.00");
					//hinh.Text=r["hinh"].ToString();
                    try
                    {
		...
		private void butHinh_Click(object sender, System.EventArgs e)
		{
            ...
            of.Filter = "Files (*.bmp)|*.bmp|(*.jpg)|*.jpg|All Files (*.*)|*.*";
