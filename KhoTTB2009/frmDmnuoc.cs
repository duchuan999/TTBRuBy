...
namespace TTB
{
	...
	/// </summary>
	public class frmDmnuoc : System.Windows.Forms.Form
	{
		...
		public frmDmnuoc(AccessData acc,int nhom,int userid)
		{
			//
		...
		{
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmDmnuoc));
            ...
            this.butKetthuc.Location = new System.Drawing.Point(516, 490);
            ...
            this.butMoi.Location = new System.Drawing.Point(216, 490);
            ...
            this.butSua.Location = new System.Drawing.Point(276, 490);
            ...
            this.butLuu.Location = new System.Drawing.Point(336, 490);
            ...
            this.butBoqua.Location = new System.Drawing.Point(396, 490);
            ...
            this.butHuy.Location = new System.Drawing.Point(456, 490);
            ...
            this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.frmDmnuoc_KeyDown);
            this.Load += new System.EventHandler(this.frmDmnuoc_Load);
		...
		private void frmDmnuoc_Load(object sender, System.EventArgs e)
		{
            if (Screen.PrimaryScreen.WorkingArea.Width > 800) this.WindowState = System.Windows.Forms.FormWindowState.Normal;
            user = ttb.user; itable = ttb.tableid("", "ttb_dmnuoc");
			nhomcc.DisplayMember="TEN";
			nhomcc.ValueMember="ID";
			nhomcc.DataSource=ttb.get_data("select * from "+user+".ttb_nhomnuoc where nhom="+i_nhom+" order by stt").Tables[0];
			load_grid();
			AddGridTableStyle();
			ref_text();
		}
		...
		{
            dt = ttb.get_data("select a.*,b.ten as tennhom from " + user + ".ttb_dmnuoc a," + user + ".ttb_nhomnuoc b where a.loai=b.id and a.nhom=" + i_nhom + " order by a.stt").Tables[0];
		...
		private void butMoi_Click(object sender, System.EventArgs e)
		{
			try
			{
                stt.Value = decimal.Parse(ttb.get_data("select max(stt) from " + user + ".ttb_dmnuoc where nhom=" + i_nhom).Tables[0].Rows[0][0].ToString()) + 1;
			}
			catch{stt.Value=1;}
			l_id=0;
			ten.Text="";
		...
		private void butSua_Click(object sender, System.EventArgs e)
		{
			...
			ena_object(true);
            if (ttb.get_data("select * from " + user + ".ttb_dmbd where manuoc=" + l_id).Tables[0].Rows.Count != 0)
			{
				ten.Enabled=false;
			}
			stt.Focus();
		...
		private void butLuu_Click(object sender, System.EventArgs e)
		{
            ...
            if (l_id == 0)
            {
                l_id = ttb.get_id_dmnuoc;
                ttb.upd_eve_tables(itable, i_userid, "ins");
            }
            else
            {
                ttb.upd_eve_tables(itable, i_userid, "upd");
                ttb.upd_eve_upd_del(itable, i_userid, "upd", ttb.fields(user + ".ttb_dmnuoc", "id=" + l_id));
            }
			if (!ttb.upd_dmnuoc(l_id,ten.Text,int.Parse(nhomcc.SelectedValue.ToString()),i_nhom,int.Parse(stt.Value.ToString())))
			{
		...
		private void butHuy_Click(object sender, System.EventArgs e)
		{
			...
			try
			{
				if (ttb.get_data("select * from "+user+".ttb_dmbd where manuoc="+decimal.Parse(dataGrid1[dataGrid1.CurrentCell.RowNumber,3].ToString())).Tables[0].Rows.Count!=0)
				{
			...
			if (MessageBox.Show("Đồng ý hủy thông tin này !",ttb.Msg,MessageBoxButtons.YesNo,MessageBoxIcon.Question)==DialogResult.Yes)
			{
                ...
                ttb.upd_eve_upd_del(itable, i_userid, "del", ttb.fields(user + ".ttb_dmnuoc", "id=" + l_id));
				ttb.execute_data("delete from "+user+".ttb_dmnuoc where id="+l_id);
				if (!ttb.bDanhmuc) ttb.writeXml("ttb_thongso","c01","1");
				load_grid();
			}
		}
		...
		private void frmDmnuoc_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
		{
