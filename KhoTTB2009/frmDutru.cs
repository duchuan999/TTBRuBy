...
namespace TTB
{
	...
	public class frmDutru : System.Windows.Forms.Form
	{
		...
		public frmDutru(AccessData acc,int nhom,string ngay,int loai,int userid,string users,string makp,string mmyy,string kho,bool giaban)
		{
			//
			...
			s_kho=kho;
			bGiaban=giaban;
			this.Text="Duyệt dù trù thuốc, vật tư y tế theo người bệnh ("+users.Trim()+")";
			//
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(frmDutru));
			...
			this.butKetthuc.Location = new System.Drawing.Point(444, 486);
			...
			this.butDuyet.Location = new System.Drawing.Point(144, 486);
			...
			this.butThuhoi.Location = new System.Drawing.Point(219, 486);
			...
			this.butIn.Location = new System.Drawing.Point(294, 486);
			...
			this.butTim.Location = new System.Drawing.Point(369, 486);
		...
		private void frmDutru_Load(object sender, System.EventArgs e)
		{
			...
			sql="select a.id,a.mabn,b.hoten,to_char(a.ngay,'dd/mm/yyyy') ngay,a.phieu,a.makp,a.idduyet,a.makhoa from ttb_xuatsdll a,"+ttb.user+".btdbn b ";
			sql+="where a.mabn=b.mabn and a.loai="+i_loai+" and a.nhom="+i_nhom+" and a.mmyy='"+s_mmyy+"'";
		...
		{
			sql="select a.stt,a.sttt,e.doituong,a.mabd,b.ma,trim(b.ten)||' '||b.hamluong ten,b.tenhc,b.dang,f.ten tenkho,c.ten tennguon,d.ten tennhomcc,a.handung,nvl(a.losx,' ') losx,a.soluong,a.giamua dongia,round(a.soluong*a.giamua,3) sotien,a.giaban,a.giamua,a.madoituong,a.makho,a.manguon,a.nhomcc,'xx/xx/xxxx' ngay ";
			sql+=" from ttb_xuatsdct a,"+ttb.user+".ttb_dmbd b,"+ttb.user+".ttb_dmnguon c,"+ttb.user+".ttb_nhomcc d,"+ttb.user+".ttb_doituong e,"+ttb.user+".ttb_dmkho f ";
		...
		{
			//Binh: sua load theo buoi
			sql="select c.makp,b.mabd,sum(b.slyeucau-b.slthuc) soluong, c.loai,c.phieu, f.ten tenphieu ";
			...
			sql+=" and c.done<>0 and b.slyeucau>b.slthuc and b.tutruc=0 group by c.makp,b.mabd,c.loai,c.phieu, f.ten order by c.makp,c.loai,c.phieu,b.mabd";
		...
		private void butDuyet_Click(object sender, System.EventArgs e)
		{
			...
			frmDuyet f=new frmDuyet(ttb,dtll,i_nhom,i_loai,s_makp,s_mmyy,s_kho,this.Text,s_ngay,i_userid,false,false,1,false);
			f.ShowDialog(this);
			if (f.bOk)
			{
				dtll=f.dtll;
