...
namespace TTB
{
	...
	public class frmHoantrathua : System.Windows.Forms.Form
	{
		...
		public frmHoantrathua(AccessData acc,int nhom,string ngay,int loai,int userid,string users,string makp,string mmyy,string kho,bool giaban,int thuoc)
		{
			//
			// Required for Windows Form Designer support
			//
			InitializeComponent();
            ttb = acc; i_nhom = nhom; i_loai = loai; i_userid = userid; s_ngay = ngay; s_makp = makp;
            s_mmyy = mmyy; s_kho = kho; bGiaban = giaban; i_thuoc = thuoc; this.Text = users;
			//
		...
		private void InitializeComponent()
		{
            ...
            this.mabn.Location = new System.Drawing.Point(72, 8);
            this.mabn.Name = "mabn";
            ...
            this.ngay.Location = new System.Drawing.Point(208, 8);
            this.ngay.Name = "ngay";
            ...
            this.phieu.Location = new System.Drawing.Point(328, 8);
            this.phieu.Name = "phieu";
            this.phieu.Size = new System.Drawing.Size(152, 21);
            ...
            this.butKetthuc.Location = new System.Drawing.Point(488, 486);
            ...
            this.butDuyet.Location = new System.Drawing.Point(244, 486);
            ...
            this.butThuhoi.Location = new System.Drawing.Point(305, 486);
            this.butThuhoi.Name = "butThuhoi";
            this.butThuhoi.Size = new System.Drawing.Size(60, 25);
            ...
            this.butIn.Location = new System.Drawing.Point(366, 486);
            ...
            this.butTim.Location = new System.Drawing.Point(427, 486);
		...
		private void frmHoantrathua_Load(object sender, System.EventArgs e)
		{
			...
			dtdmbd=ttb.get_data("select * from "+user+".ttb_dmbd where nhom="+i_nhom+" order by id").Tables[0];
			...
			sql="select a.id,mabn,b.ten as hoten,to_char(a.ngay,'dd/mm/yyyy') as ngay,a.phieu,a.makp,a.idduyet,a.makhoa from "+xxx+".ttb_xuatsdll a,"+d.user+".d_duockp"+link+" b ";
            sql += "where a.makp=b.id and a.maql=0 and a.loai=" + i_loai + " and a.nhom=" + i_nhom;
		...
		private void load_treeview()
		{
			...
			sql+=" from "+xxx+".ttb_hoantrall a,"+xxx+".ttb_hoantract b,"+xxx+".ttb_duyet c,"+user+".ttb_dmbd d, "+user+".ttb_dmphieu e, "+user+".ttb_loaiphieu f ";
			sql+=" where a.id=b.id and a.idduyet=c.id and b.mabd=d.id and c.loai=e.id and c.phieu=f.id ";
			sql+=" and a.maql=0 and c.nhom="+i_nhom+" and c.loai="+i_loai;
		...
		private void butThuhoi_Click(object sender, System.EventArgs e)
		{
			...
			frmThuhoi f=new frmThuhoi(ttb,dtll,dtct,dtkp,dtphieu,int.Parse(makp.SelectedValue.ToString()),int.Parse(phieu.SelectedValue.ToString()),s_ngay,s_mmyy,i_nhom,i_loai,false,true,i_thuoc,s_kho,i_userid);
			f.ShowDialog(this);
			if (f.bOk)
			{
				dtll.AcceptChanges();
		...
		{
			frmInphieu f=new frmInphieu(ttb,dtkp,dtphieu,(makp.SelectedIndex==-1)?-1:int.Parse(makp.SelectedValue.ToString()),(phieu.SelectedIndex==-1)?-1:int.Parse(phieu.SelectedValue.ToString()),s_ngay,s_mmyy,i_nhom,i_loai,s_kho,"PHIẾU HOÀN TRẢ",false);
			f.ShowDialog(this);
		}
		...
		{
			l_id=0;
			frmTimhoantrathua f=new frmTimhoantrathua(this);
			f.MdiParent=parent;
			f.RefreshText("");
			f.Show();
		}
