...
namespace TTB
{
	public class frmRight : System.Windows.Forms.Form
	{
		...
		{
			InitializeComponent();
			ttb=acc;i_nhom=nhom;s_userid=user;
            f_Load_Tree();
		}
		...
		private void InitializeComponent()
		{
            ...
            this.butAll.Location = new System.Drawing.Point(224, 2);
            this.butAll.Name = "butAll";
            this.butAll.Size = new System.Drawing.Size(72, 25);
            ...
            this.butKethuc.Location = new System.Drawing.Point(360, 2);
            this.butKethuc.Name = "butKethuc";
            this.butKethuc.Size = new System.Drawing.Size(68, 25);
            ...
            this.butLuu.Location = new System.Drawing.Point(100, 2);
            ...
            this.butHuy.Location = new System.Drawing.Point(162, 2);
            ...
            this.butSua.Location = new System.Drawing.Point(298, 2);
            ...
            this.butThem.Location = new System.Drawing.Point(38, 2);
        ...
        {
            user = ttb.user;
            ds = ttb.get_data("select * from " + user + ".ttb_dlogin");
		...
		private void luu_right()
		{
			try
			{
                ttb.upd_dlogin_right(int.Parse(dataGrid1[dataGrid1.CurrentCell.RowNumber, 6].ToString()), strRight);
                ttb.updrec_right(ds.Tables[0], int.Parse(dataGrid1[dataGrid1.CurrentCell.RowNumber, 6].ToString()), strRight);
			}
			catch{}
		}
		...
		{
            frmUser f = new frmUser(ttb, ds, 0, "", "", "", i_nhom, "", "", true, "", s_userid, "", "");
            f.ShowDialog();
            ds = f.dsright;
		}
		...
		private void butHuy_Click(object sender, System.EventArgs e)
		{
            ...
            {
                MessageBox.Show("Không được hủy !", ttb.Msg);
                return;
            }
            if (MessageBox.Show("Đồng ý hủy ?", ttb.Msg, MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                ttb.execute_data("delete from " + user + ".ttb_dlogin where id=" + decimal.Parse(dataGrid1[dataGrid1.CurrentCell.RowNumber, 6].ToString()));
                ttb.delrec(ds.Tables[0], "id=" + decimal.Parse(dataGrid1[dataGrid1.CurrentCell.RowNumber, 6].ToString()));
                ds.AcceptChanges();
            }
		}
        ...
        {
            adsRight = ttb.get_data("select * from " + ttb.user + ".ttb_menuitem");
        ...
        private void f_Paste()
        {
            try
            {
                ...
                {
                    if (MessageBox.Show(this, "Đồng ý paste quyền cho đối tượng đang chọn!", ttb.Msg, MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) == DialogResult.Yes)
                    {
                        ttb.execute_data("update "+ttb.user+".ttb_dlogin set right_='" + m_id_copy + "' where id=" + auserid + " and nhomkho="+i_nhom);
                        ref_text(m_id_copy);
                    }
                }
            }
