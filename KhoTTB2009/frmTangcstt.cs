...
{
	/// <summary>
	/// Summary description for frmTangcstt.
	/// </summary>
	public class frmTangcstt : System.Windows.Forms.Form
	{
		...
		private string s_mmyy,s_ngay,sql,s_loai,s_ngaysp,s_makho,s_makp,format_soluong,format_dongia,format_sotien;
		...
		public frmTangcstt(AccessData acc,string loai,string mmyy,string ngay,int nhom,int userid,string kho,string makp,string title,bool b_giaban)
		{
			//
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(frmTangcstt));
			...
			// label10
			// 
			this.label10.Location = new System.Drawing.Point(396, 8);
			...
			this.khox.Location = new System.Drawing.Point(288, 8);
			this.khox.Name = "khox";
			this.khox.Size = new System.Drawing.Size(111, 21);
			...
			this.khon.Location = new System.Drawing.Point(436, 8);
			this.khon.Name = "khon";
			...
			// ldvt
			// 
			this.ldvt.Location = new System.Drawing.Point(437, 439);
			this.ldvt.Name = "ldvt";
			...
			// label16
			// 
			this.label16.Location = new System.Drawing.Point(512, 439);
			...
			// label20
			// 
			this.label20.Location = new System.Drawing.Point(184, 460);
			...
			this.dang.Location = new System.Drawing.Point(472, 438);
			this.dang.Mask = "";
			...
			this.soluong.Location = new System.Drawing.Point(568, 438);
			...
			this.dongia.Location = new System.Drawing.Point(680, 438);
			...
			// label15
			// 
			this.label15.Location = new System.Drawing.Point(507, 460);
			...
			// label24
			// 
			this.label24.Location = new System.Drawing.Point(598, 460);
			...
			this.handung.Location = new System.Drawing.Point(568, 461);
			this.handung.Mask = "####";
			this.handung.Name = "handung";
			this.handung.Size = new System.Drawing.Size(64, 21);
			...
			this.losx.Location = new System.Drawing.Point(680, 461);
			this.losx.Mask = "&&&&&&&&&&";
			...
			this.tenhc.Location = new System.Drawing.Point(498, 544);
			...
			// lTenhc
			// 
			this.lTenhc.Location = new System.Drawing.Point(440, 544);
			...
			this.giaban.Location = new System.Drawing.Point(416, 592);
			...
			// label25
			// 
			this.label25.Location = new System.Drawing.Point(361, 592);
			...
			// label3
			// 
			this.label3.Location = new System.Drawing.Point(172, 592);
			...
			this.manguon.Location = new System.Drawing.Point(232, 461);
			this.manguon.Name = "manguon";
			this.manguon.Size = new System.Drawing.Size(280, 21);
			...
			this.nhomcc.Location = new System.Drawing.Point(242, 592);
			...
			this.Name = "frmTangcstt";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Phiếu xuất tăng cơ số tủ trực";
			this.WindowState = System.Windows.Forms.FormWindowState.Maximized;
			this.Load += new System.EventHandler(this.frmTangcstt_Load);
		...
		private void frmTangcstt_Load(object sender, System.EventArgs e)
		{
			...
			dtll=ttb.get_data("select id,sophieu,to_char(ngay,'dd/mm/yyyy') ngay,khox,khon,lydo from "+ttb.user+s_mmyy+".ttb_xuatll where loai='"+s_loai+"'"+" and userid="+i_userid+" and nhom="+i_nhom+" order by id").Tables[0];
		...
		{
			sql="select a.stt,a.sttt,a.mabd,b.ma,trim(b.ten)||' '||b.hamluong ten,nvl(b.tenhc,' ') tenhc,b.dang,c.ten tennguon,d.ten tennhomcc,a.handung,a.losx,a.soluong,a.giamua dongia,round(a.soluong*a.giamua,3) sotien,a.giaban,a.giamua,a.manguon,a.nhomcc,a.sothe ";
		...
		private bool KiemtraHead()
		{
			...
			{
				MessageBox.Show("Nhập khoa nhập !",ttb.Msg);
				khon.Focus();
				return false;
			}
			return true;
		...
		private void butXoa_Click(object sender, System.EventArgs e)
		{
			if (sttt.Text!="" && !bNew)
			{
				d_soluongton=ttb.get_tutruc(s_mmyy,int.Parse(khox.SelectedValue.ToString()),int.Parse(khon.SelectedValue.ToString()),decimal.Parse(sttt.Text));
		...
		private void butHuy_Click(object sender, System.EventArgs e)
		{
			try
			{
				...
				{
					d_soluongton=ttb.get_tutruc(s_mmyy,int.Parse(khox.SelectedValue.ToString()),int.Parse(khon.SelectedValue.ToString()),decimal.Parse(r1["sttt"].ToString()));
		...
		{
//			sql="select rownum stt,c.ten tennguon,b.ma,trim(b.ten)||' '||b.hamluong ten,b.tenhc,b.dang,d.ten tenhang,a.tondau+a.slnhap-a.slxuat-a.slyeucau soluong,b.id,a.makho,a.manguon from d_tonkhoth a,"+d.user+".d_dmbd b,"+d.user+".d_dmnguon c,"+d.user+".d_dmhang d where a.mabd=b.id and a.manguon=c.id and b.mahang=d.id and a.makho="+int.Parse(khox.SelectedValue.ToString())+" and a.mmyy='"+s_mmyy+"'"+" order by b.ten";
//			dtton=d.get_data(s_mmyy,sql).Tables[0];
		...
		private void butLuu_Click(object sender, System.EventArgs e)
		{
			...
			sql="select a.*,b.ten tennguon,c.ten tennhomcc from ttb_tonkhoct a,"+ttb.user+".ttb_dmnguon b,"+ttb.user+".ttb_nhomcc c where a.manguon=b.id and a.nhomcc=c.id and a.makho="+int.Parse(khox.SelectedValue.ToString())+" and a.mmyy='"+s_mmyy+"'";
		...
		private void butIn_Click(object sender, System.EventArgs e)
		{
			...
			if (ttb.bPreview)
			{
				frmReport f=new frmReport(ttb,dtct,"d_phieuxuat.rpt",cmbSophieu.Text,ngaysp.Text,"","",khon.Text,"Tăng cơ số tủ trực",khox.Text,doiso.Doiso_Unicode(Convert.ToInt64(d_tongcong).ToString()),"","");
				f.ShowDialog();
			}
			else
			{
				string lydo="Tăng cơ số tủ trực";
				ReportDocument oRpt=new ReportDocument();
				oRpt.Load("..\\..\\..\\report\\d_phieuxuat.rpt",OpenReportMethod.OpenReportByTempCopy);
				oRpt.SetDataSource(dtct);
				oRpt.DataDefinition.FormulaFields["soyte"].Text="'"+ttb.Tenbv+"'";
				oRpt.DataDefinition.FormulaFields["benhvien"].Text="'"+ttb.Diachi+"'";
