...
namespace Duoc
{
	...
	/// </summary>
	public class frmXemtonvayct : System.Windows.Forms.Form
	{
		...
		private string sql,format_sotien,format_soluong,format_dongia;
		...
		public frmXemtonvayct(AccessData acc,int kho,int makp,string tenkho,bool b_giaban,int nhom)
		{
			//
			...
			i_nhom=nhom;
			bGiaban=b_giaban;
			this.Text="Tồn "+tenkho.Trim()+" vay chi tiết";
			//
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(frmXemtonvayct));
			...
			this.butKetthuc.Location = new System.Drawing.Point(398, 490);
			...
			this.butRef.Location = new System.Drawing.Point(319, 490);
			...
			this.Name = "frmXemtonvayct";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Xem tồn kho";
			this.WindowState = System.Windows.Forms.FormWindowState.Maximized;
			this.Load += new System.EventHandler(this.frmXemtonvayct_Load);
		...
		private void frmXemtonvayct_Load(object sender, System.EventArgs e)
		{
		...
		{
			sql="select c.ten tennguon,d.ten tennhomcc,b.ma,trim(b.ten)||' '||b.hamluong tenbd,b.tenhc,b.dang,a.handung,a.losx,a.tondau,a.sttondau,a.slvay as slnhap,a.stvay as stnhap,a.slquyettoan as slxuat,a.stquyettoan as stxuat,a.tondau+a.slvay-a.slquyettoan toncuoi,a.sttondau+a.stvay-a.stquyettoan sttoncuoi,a.giaban,a.giamua ";
			sql+=" from d_tonvayct a,d_dmbd b,d_dmnguon c,d_nhomcc d ";
			sql+=" where a.mabd=b.id and a.manguon=c.id and a.nhomcc=d.id and a.makho="+i_kho+" and a.makp="+i_makp+" order by a.stt";
