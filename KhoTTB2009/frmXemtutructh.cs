...
namespace TTB
{
	...
	public class frmXemtutructh : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            this.butKetthuc.Location = new System.Drawing.Point(397, 491);
		...
		private void load_grid()
		{
			...
			sql+=" from "+xxx+".ttb_tutructh a,"+user+".ttb_dmbd b,"+user+".ttb_dmnguon c,"+user+".ttb_dmnhom d";
			sql+=" where a.mmyy='"+s_mmyy+"' and a.mabd=b.id and b.manhom=d.id and a.manguon=c.id and d.theodoi=1 and b.bhyt<>0 and a.makho="+i_kho+" and a.makp="+i_makp+" order by b.ten";
