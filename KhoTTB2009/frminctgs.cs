...
namespace TTB
{
	...
	public class frminctgs : System.Windows.Forms.Form
	{
		...
		public frminctgs(int nhomkho,string makho,string mmyy)
		{
			//
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(frminctgs));
			...
			this.butIn.Location = new System.Drawing.Point(64, 288);
			...
			this.butKetthuc.Location = new System.Drawing.Point(144, 288);
			this.butKetthuc.Name = "butKetthuc";
			this.butKetthuc.Size = new System.Drawing.Size(88, 28);
			...
			// checkBox1
			// 
			this.checkBox1.Font = new System.Drawing.Font("Tahoma", 9F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
		...
		private void load_ctughiso(string s_no, string s_co, string s_makho)
		{
			...
			for(int i=int.Parse(s_tu);i<=int.Parse(s_den);i++)
			{
				if (ttb.bMmyy(i.ToString().PadLeft(2,'0')+s_yy))
				{
					...
					if (j!=0) ds.Merge(ttb.get_data(sql));//i.ToString().PadLeft(2,'0')+s_yy
                    else ds = ttb.get_data(sql);//i.ToString().PadLeft(2,'0')+s_yy
					j++;
				}
			}
		}
		...
		{
			string s_sql="select * from ttb_dmkho where nhom="+i_nhomkho;
