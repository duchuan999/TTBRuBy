...
{
	/// <summary>
	/// Summary description for rptBctheonhom.
	/// </summary>
	public class rptBctheonhom : System.Windows.Forms.Form
	{
		...
		private string sql,s_mmyy,s_tu,s_den,s_yy,s_kho,s_manhom,s_makho;
		...
		public rptBctheonhom(AccessData acc,int nhom,string kho,string mmyy)
		{
			//
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(rptBctheonhom));
			...
			this.manhom.Location = new System.Drawing.Point(253, 7);
			this.manhom.Name = "manhom";
			this.manhom.Size = new System.Drawing.Size(264, 212);
			this.manhom.TabIndex = 13;
			// 
			// rptBctheonhom
			// 
			...
			this.Name = "rptBctheonhom";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Báo cáo sử dụng theo nhóm";
			this.Load += new System.EventHandler(this.rptBctheonhom_Load);
			this.MouseMove += new System.Windows.Forms.MouseEventHandler(this.rptBctheonhom_MouseMove);
			...
			foreach(DataRow r in ttb.get_data(sql).Tables[0].Rows)//d_mmyy
			{
				...
				if ( r1 == null )
				{
					...
					if (r3!=null)
					{
						...
						r2["maloai"]=r3["manhom"].ToString();
						r2["tenloai"]=r3["tennhom"].ToString();
		...
		{
			ttb.writeXml("ttb_thongso","manhom",s_manhom);
			this.Close();		
		}
		...
		private void rptBctheonhom_MouseMove(object sender, System.Windows.Forms.MouseEventArgs e)
		{
			if (bClear)
			{
				...
				for(int i=0;i<dtdmnhom.Rows.Count;i++)
					if (snhom.IndexOf(","+dtdmnhom.Rows[i]["id"].ToString().Trim()+",")!=-1) manhom.SetItemCheckState(i,CheckState.Checked);
