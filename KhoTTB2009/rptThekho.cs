...
namespace TTB
{
	...
	public class rptThekho : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            this.butKetthuc.Location = new System.Drawing.Point(322, 379);
            ...
            this.tim.Location = new System.Drawing.Point(56, 349);
            this.tim.Name = "tim";
            this.tim.Size = new System.Drawing.Size(360, 21);
            this.tim.TabIndex = 8;
        ...
        private void load_grid()
        {
            ...
            {
                s_mmyy += "'" + i.ToString().PadLeft(2, '0') + s_yy + "',";
            }
            s_mmyy = s_mmyy.Trim(',');
            sql = "select a.mabd,b.ma,trim(b.ten)||' '||b.hamluong as ten,b.tenhc,b.dang,c.ten as tenhang," +
                       "a.tondau+a.slnhap-a.slxuat as toncuoi,e.stt from " + user + ".ttb_tonkhoth a," +
                       user + ".ttb_dmbd b," + user + ".ttb_dmhang c," + user + ".ttb_dmnhom d," +
                       user + ".ttb_nhomin e where (a.mabd=b.id and b.mahang=c.id and b.manhom=d.id " +
                       " and d.nhomin=e.id and a.makho=" + int.Parse(kho.SelectedValue.ToString());
            sql += " and a.mmyy in(" + s_mmyy + ")";
            ...
            foreach (DataRow r in ttb.get_data(sql).Tables[0].Rows) ttb.updrec_thekho(dsdm.Tables[0], int.Parse(r["mabd"].ToString()), r["ma"].ToString(), r["ten"].ToString(), r["tenhc"].ToString(), r["dang"].ToString(), r["tenhang"].ToString(), decimal.Parse(r["toncuoi"].ToString()), int.Parse(r["stt"].ToString()));
